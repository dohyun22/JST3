...
public class GUIMeter extends GUIBase {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
	    ...
	    if (((ContainerMeter) this.inventorySlots).displayRF)
	    	drawTexturedModalRect(x + 151, y + 31, 176, 0, 18, 18);
	}

	@Override
	protected void drawGuiContainerForegroundLayer(int p1, int p2){
		ContainerMeter con = (ContainerMeter) this.inventorySlots;
		this.fontRenderer.drawString(I18n.format("jst.msg.meter.total", con.displayRF ? (con.sum * JSTCfg.RFPerEU) + " RF" : con.sum + " EU"), 13, 18, 24576);
		this.fontRenderer.drawString(I18n.format("jst.msg.meter.avg", con.displayRF ? (con.avg * JSTCfg.RFPerEU) + " RF" : con.avg + " EU"), 13, 32, 24576);
		this.fontRenderer.drawString(I18n.format("jst.msg.meter.amp", con.amp), 13, 46, 24576);
	}
