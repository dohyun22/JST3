...
public class JSTFluids {
	...
	public static void preInit() {
		oil = createFluid("oil", 0, 500, 300, 5000, false, EnumRarity.COMMON);
		fuel = createFluid("fuel", 0, 300, 300, 1000, false, EnumRarity.COMMON);
		nitrofuel = createFluid("nitrofuel", 0, 400, 300, 1000, false, EnumRarity.UNCOMMON);
		naturalGas = createFluid("gas.natural", 0, -50, 300, 0, true, EnumRarity.COMMON);
		lng = createFluid("liquid_lng", 0, 50, 250, 100, false, EnumRarity.COMMON);
		lpg = createFluid("liquid_lpg", 0, 50, 250, 100, false, EnumRarity.COMMON);
		hydrogen = createFluid("hydrogen", 0, -300, 300, 0, true, EnumRarity.COMMON);
		deuterium = createFluid("deuterium", 0, -200, 300, 0, true, EnumRarity.COMMON);
		tritium = createFluid("tritium", 0, -180, 300, 0, true, EnumRarity.RARE);
		helium3 = createFluid("helium3", 0, -180, 300, 0, true, EnumRarity.RARE);
		helium = createFluid("helium", 0, -100, 300, 0, true, EnumRarity.COMMON);
		lithium = createFluid("lithium", 0, 534, 454, 2000, false, EnumRarity.COMMON);
		carbon = createFluid("carbon", 4, 2260, 3823, 4000, false, EnumRarity.COMMON);
		nitrogen = createFluid("nitrogen", 0, 0, 300, 0, true, EnumRarity.COMMON);
		oxygen = createFluid("oxygen", 0, 0, 300, 0, true, EnumRarity.COMMON);
		sodium = createFluid("sodium", 0, 971, 371, 2000, false, EnumRarity.COMMON);
		chlorine = createFluid("chlorine", 0, 60, 300, 0, true, EnumRarity.COMMON);
		silicon = createFluid("silicon", 4, 2330, 1687, 4000, false, EnumRarity.COMMON);
		mercury = createFluid("mercury", 0, 13593, 300, 2000, false, EnumRarity.COMMON);
		steam = createFluid("steam", 0, -50, 500, 0, true, EnumRarity.COMMON);
		acid = createFluid("acid", 0, 1200, 300, 1000, false, EnumRarity.COMMON);
		air = createFluid("air", 0, 0, 300, 0, true, EnumRarity.COMMON);
		heavyfuel = createFluid("heavyfuel", 0, 1000, 300, 2000, false, EnumRarity.COMMON);
